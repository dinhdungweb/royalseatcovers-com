  ...
  class ProductInfo extends HTMLElement {
    ...
    handleUpdateProductInfo(productUrl, viewMode) {
      return (html) => {
        ...
        // price update inside button
        const priceInButtonSource = html.querySelector('[data-price-in-button]');
        const priceInButtonDest = this.querySelector('[data-price-in-button]');

        if (priceInButtonDest) {
          if (priceInButtonSource && variant) {
            priceInButtonDest.innerHTML = priceInButtonSource.innerHTML;
            priceInButtonDest.style.display = ''; 
          } else {
            priceInButtonDest.style.display = 'none';
          }
        }
